...
def getInfoFromCplexFile():
    ...
    return matrizNaoBasica, matrizBasica, vetorB, cn, cb, maxOrMin, nomeVariaveis, precisaFaseUm, variaveisArtificiais
...
def adicionarVariaveisArtificiais(matrizNaoBasica, custo_n, numeroArtificiais):
    for i in range(numeroArtificiais):
        ...
        novaVariavelArtificial = [0.0] * len(custo_n)
        novaVariavelArtificial[len(custo_n) - numeroArtificiais + i] = 1.0
        custo_n.extend(novaVariavelArtificial)
...
def main():
    matrizNaoBasica, matrizBasica, vetorB, cn, cb, maxOrMin, nomeVariaveis, precisaFaseUm, numeroArtificiais = getInfoFromCplexFile()
    if precisaFaseUm:
